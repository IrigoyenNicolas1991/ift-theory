...
| **Campaña m₂=0** (el medio U(X,Y) realiza la fase protegida de Dubovsky) | `campana-m2/` (handoff 2026-07-20 + 3 actas con paneles adversariales) | `campana-m2/**/*.py` (SymPy) | **tareas 1-2-3 SALDADAS 2026-07-21**: errata BCP (7.6)-(7.7) verificada 5 vías; escalar congelado a LO (ω²(p) exacta propia, diccionario ghost condensate); acople: γ=1 exacta por teorema causal, frame dragging con DOS RAMAS (Yukawa Meissner derivado / RG disfrazado) + cota Λ≲2-2.6 MeV, LARES-2→1.12; **paper borrador v0.1 escrito** (ver tabla de papers); barrido INSPIRE de novedad hecho (0 hits en la simetría); pendientes: FRW, mapeo nota 10, selección de estado |
...
| **La fila que falta** — "The missing row: unrestricted internal diffeomorphisms, the protected phase of Lorentz-violating massive gravity, and a screened frame-dragging signature" | `PAPER-borrador-missing-row-UXY.md` | **draft v0.2 AUDITADO** (2026-07-21, mismo día que el v0.1): el paper de la campaña m₂=0 — standalone (se defiende sin TCI); las 3 patas técnicas pasaron paneles adversariales (actas en `campana-m2/`) y el TEXTO pasó su 1ª auditoría adversarial (31 hallazgos, TODOS aplicados; acta `campana-m2/AUDITORIA-TEXTO-PAPER-2026-07-21.md`); suite de scripts reparada y reproducible desde el repo; barrido INSPIRE con acta (`campana-m2/BARRIDO-INSPIRE-2026-07-21.md`); incluye la medición Nature jul-2026 de LARES-2 con la disputa citada; falta 2ª pasada de auditoría + OK de canal; blanco: arXiv hep-th/gr-qc + PRD/JCAP |
