...
| **La fila que falta** — "The missing row: unrestricted internal diffeomorphisms, the protected phase of Lorentz-violating massive gravity, and a screened frame-dragging signature" | `PAPER-borrador-missing-row-UXY.md` | **draft v0.1** (2026-07-21): el paper de la campaña m₂=0 — standalone (se defiende sin TCI); las 3 patas técnicas YA pasaron paneles adversariales (actas en `campana-m2/`), el TEXTO aún no tiene auditoría propia; barrido INSPIRE de novedad hecho (declarado adentro); lista de bloqueo adentro; blanco: arXiv hep-th + PRD/JCAP |
